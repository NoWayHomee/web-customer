...
const Login = () => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Simulate getting a name from email (e.g. user@gmail.com -> User)
            ...
            <form onSubmit={handleLogin}>
              <div className="mb-8">
                ...
                <input
                  ...
                  className="w-full border-b border-gray-400 py-2 text-gray-900 placeholder-gray-300 focus:outline-none focus:border-black transition-colors"
                />
              </div>
